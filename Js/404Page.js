...
document.addEventListener('DOMContentLoaded', () => {
  ...
  handleScroll();document.addEventListener("DOMContentLoaded", () => {
    ...
    if (window.location.pathname.endsWith("404Page.html") ||
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const shutter = document.querySelector('.shutter-animation');
    if (shutter) {
      shutter.addEventListener('mouseenter', () => {
        document.querySelectorAll('.shutter-blade').forEach(blade => {
          blade.style.animationPlayState = 'paused';
          blade.style.borderColor = 'var(--brand-primary)';
